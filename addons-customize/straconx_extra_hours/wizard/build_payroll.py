...
setup_fields = {
    'name_payroll': {'string': 'Payroll name', 'type': 'text','default':'vacio','required': True},
...
def _build(self, cr, uid, data, *args):
    ...
    name_payroll = unicode(data['form']['name_payroll'],'latin1')

    pr_id = pool_pay.build(cr, uid, date_from, date_to, employee_ids, name_payroll)
