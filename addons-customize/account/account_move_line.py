                    ...
                    if payment_line.currency_id and move_line.currency_id and payment_line.currency_id.id == move_line.currency_id.id:
                        ...
                        if move_line.currency_id:
                            ...
                            if (move_line.account_id.type == ('payable')):
                                dif =(payment_line.credit - payment_line.debit)
                            if (move_line.account_id.type in ('receivable')):
                                dif =(payment_line.debit- payment_line.credit)
                            amount_in_foreign_currency = cur_obj.compute(cr, uid, move_line.company_id.currency_id.id, move_line.currency_id.id, dif, round=False, context=context_unreconciled)
...
#                print l.account_id.name, l.company_id, l.account_id.company_id,l.company_id ,l.period_id.company_id
                return False
        return True
