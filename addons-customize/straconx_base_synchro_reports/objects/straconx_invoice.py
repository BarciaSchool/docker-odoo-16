                        ...
                        for model_ids in model_objs:
                            ...
                            if fields_app:
                                if model == 'account_invoice':
                                    ...
                                    sql_fields_app = ("""select * from %s where id=(select move_id from account_invoice where id =%s)"""%(model,define_record))                                
                                elif model == 'account_move_line':
                                    sql_fields_app = ("""select * from %s where move_id=(select move_id from account_invoice where id =%s)"""%(model,define_record))                                                                
