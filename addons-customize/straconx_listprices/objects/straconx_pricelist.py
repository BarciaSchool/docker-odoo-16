...
class product_pricelist_item(osv.osv):
    ...
    _columns = {
        ...
        'min_quantity': fields.integer('Min. Quantity',  help="The rule only applies if the partner buys/sells more than this quantity."),
        'sequence': fields.integer('Sequence', help="Gives the order in which the pricelist items will be checked. The evaluation gives highest priority to lowest sequence and stops as soon as a matching item is found."),
        'base': fields.selection(_price_field_get, 'Based on', size=-1, help="The mode for computing the price for this rule."),
