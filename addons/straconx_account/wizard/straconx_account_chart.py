    ...
    def onchange_chart_template_id(self, cr, uid, ids, chart_template_id=False, context=None):
        ...
        if chart_template_id:
            ...
            # default tax is given by the lowest sequence. For same sequence we will take the latest created as it will be the case for tax created while isntalling the generic chart of account
                sale_tax_ids = tax_templ_obj.search(cr, uid, [("chart_template_id", "=", chart_template_id),('description','=','421'), ('type_tax_use', '=', ('sale'))], order="description asc, sequence")
                purchase_tax_ids = tax_templ_obj.search(cr, uid, [("chart_template_id" , "=", chart_template_id),('description','=','520'), ('type_tax_use', '=', ('purchase'))], order="description asc, sequence")
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        if ids:
            ...
            if 'sale_tax' in fields:
                sale_tax_ids = tax_templ_obj.search(cr, uid, [("chart_template_id", "=", ids[0]),('description','=','421'), ('type_tax_use', '=', ('sale'))], order="sequence")
                if sale_tax_ids:
            ...
            if 'purchase_tax' in fields:
                purchase_tax_ids = tax_templ_obj.search(cr, uid, [("chart_template_id" , "=", ids[0]),('description','=','520'), ('type_tax_use', '=', ('purchase'))], order="sequence")
                if purchase_tax_ids:
