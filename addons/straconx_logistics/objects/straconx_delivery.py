...
# From sale_delivery - add property in partner
...
# From sale_delivery - create a delivery carrier
...
class delivery_carrier(osv.osv):
    ...
    _columns = {
        ...
        'no_driver':fields.boolean('No required Driver', required=False),
    }
    _defaults = {
...
class delivery_grid(osv.osv):
    ...
    _columns = {
        ...
        'sequence': fields.integer('Sequence', size=64, help="Gives the sequence order when displaying a list of delivery grid."),
...
class stock_packing(osv.osv):
    _name = "stock.packing"
    _description = "Packing for Pickings"
    _columns = {
        'name': fields.char('Name', size=32, required=True),
        'auto_generate': fields.boolean('Autollenado')
    }
stock_packing()
