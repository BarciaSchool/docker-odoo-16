...
class printer_point(osv.osv):
    ...
    _columns = {
                'number_sri':fields.char('SRI Number', size=3, help='This number is assigned by the SRI by each printer point'),
    ...
    _constraints = [(_check_number,'Los puntos asignados por el SRI solo deben ser números y diferentes a 000.',['number_sri'])]
    
    _sql_constraints = [('number_printer_uniq', 'unique (number_sri,shop_id)','The number of point printer must be unique for each shop!')]
